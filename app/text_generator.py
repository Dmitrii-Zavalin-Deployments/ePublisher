...
def is_appropriate_topic(text):
    query = f"Is the topic of the following text political, offensive, insulting, violent, abusive, negative, not clear, not relevant, or otherwise inappropriate? Answer with yes or no only: {text}?\nResponse:"
